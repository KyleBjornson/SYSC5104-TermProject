...
class RoomController : public atomic<TIME, MSG>
{
    TIME _next;
...
public:
     ...
     */
    explicit RoomController(const std::string &n = "rctrl") noexcept : _next(infinity), _outvalue(std::vector<MSG>{}),_state(State::IDLE), _outputMessage(){
    	portName[rctrl_light_in] = "light_in";
    	portName[rctrl_ambient_light_in] = "ambient_light_in";
    	//portName[rctrl_emerg_in] = "emergency_in";
    	portName[rctrl_room_out] = "room_out";
    }
